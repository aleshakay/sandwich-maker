...
const condiments = [
    ...
    {id: "condiment2", name: "Mustard", price: 60 },
    {id: "condiment3", name: "Vingar", price: 50 },
    {id: "condiment4", name: "Ranch", price: 70 },
    {id: "condiment5", name: "Jalapenos", price: 100 },
    {id: "condiment6", name: "Chipotle Ranch", price: 70 },
  ];
